 ...
 * -fno-shadow -header copyright-header.txt -minimal -tmpdir dist/uint128
 * -skip-compilation -extract-uints -add-include <inttypes.h> -add-include
 * <stdbool.h> -add-include "kremlin/internal/types.h" -bundle FStar.UInt128=*
 * extracted/prims.krml extracted/FStar_Pervasives_Native.krml
 * extracted/FStar_Pervasives.krml extracted/FStar_Mul.krml
 * extracted/FStar_Squash.krml extracted/FStar_Classical.krml
 * extracted/FStar_StrongExcludedMiddle.krml
