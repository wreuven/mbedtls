 ...
 * KreMLin invocation: /mnt/e/everest/verify/kremlin/krml -fc89 -fparentheses
 * -fno-shadow -header /mnt/e/everest/verify/hdrcLh -minimal -fbuiltin-uint128
 * -fc89 -fparentheses -fno-shadow -header /mnt/e/everest/verify/hdrcLh -minimal
 * -I /mnt/e/everest/verify/hacl-star/code/lib/kremlin -I
 * /mnt/e/everest/verify/kremlin/kremlib/compat -I
 * /mnt/e/everest/verify/hacl-star/specs -I
 * /mnt/e/everest/verify/hacl-star/specs/old -I . -ccopt -march=native -verbose
 * -ldopt -flto -tmpdir x25519-c -I ../bignum -bundle Hacl.Curve25519=* -minimal
 * -add-include "kremlib.h" -skip-compilation x25519-c/out.krml -o
 * x25519-c/Hacl_Curve25519.c F* version: 059db0c8 KreMLin version: 916c37ac
 */
