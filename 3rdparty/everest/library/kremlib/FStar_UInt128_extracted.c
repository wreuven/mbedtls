 ...
 * -fno-shadow -header copyright-header.txt -minimal -tmpdir extracted
 * -warn-error +9+11 -skip-compilation -extract-uints -add-include <inttypes.h>
 * -add-include "kremlib.h" -add-include "kremlin/internal/compat.h"
